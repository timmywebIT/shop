...
Route::group(['prefix' => 'tags'], function () {
    ...
    Route::get('/tag', \App\Http\Controllers\Tag\CreateController::class)->name('tag.create');
...
Route::group(['prefix' => 'colors'], function () {
    ...
    Route::get('/color', \App\Http\Controllers\Color\CreateController::class)->name('color.create');
...
Route::group(['prefix' => 'users'], function () {
    ...
    Route::get('/user', \App\Http\Controllers\User\CreateController::class)->name('user.create');
